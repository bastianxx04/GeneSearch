...
def ex2():
    ...
    - otable-nosentinelrow
    """
    graph_variable_genome("ex2-approx", "approx", 50, reads=READS_S, spacing=1)
...
def ex5():
    ...
    - otable-nosentinelrow
    """
    graph_variable_spacing("ex5-approx", "approx", RAND_MILLION, 50, reads=READS_S)
...
def ex8():
    ...
    - otable-noskips
    """
    graph_variable_genome("ex8-approx", "approx", 50, reads=READS_S, spacing=1)
...
def graph_variable_genome(fname, type, iterations, reads=None, spacing=None):
